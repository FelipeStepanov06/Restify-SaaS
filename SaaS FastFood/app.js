...
function renderProductsGrid() {
  ...
  filteredProducts.forEach(product => {
    ...
    card.innerHTML = `
      <img src="${product.img}" alt="${product.name}" loading="lazy" onerror="this.onerror=null;this.src='https://placehold.co/400x400/eeeeee/999999?text=Sem+Foto';">
...
function buildCarouselSlides(trackId) {
  ...
  carouselProducts.forEach(carouselItem => {
    ...
    slide.innerHTML = `
      <img src="${hiResImage}" alt="${product.name}" onerror="this.onerror=null;this.src='https://placehold.co/1200x800/eeeeee/999999?text=Sem+Foto';">
